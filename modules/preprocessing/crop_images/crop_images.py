...
def main():
    ...
    input_dir = config.get_path('preprocessing', 'img_input_dir')
    output_dir = config.get_path('preprocessing', 'cropped_images_dir')
    crop_size = (224, 224)
    
    process_directory(input_dir, output_dir, crop_size)
    
    print(f"Image cropping completed! Cropped images saved to: {output_dir}")
